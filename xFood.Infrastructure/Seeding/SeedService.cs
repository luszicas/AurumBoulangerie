...
public static class SeedService
{
    public static async Task EnsureSeedAsync(IServiceProvider services)
    {
        ...
        if (!await ctx.Users.AnyAsync())
        {
            ...
            var users = new[]
            {
                new User { Name = "Chef Executivo", Email = "admin@aurum.com", Password = "123", DateBirth = new DateTime(1985,1,1), TypeUserId = roles["Administrador"], Active = true },
                new User { Name = "Maître", Email = "gerente@aurum.com", Password = "123", DateBirth = new DateTime(1992,1,1), TypeUserId = roles["Gerente"], Active = true },
                new User { Name = "Atendente", Email = "staff@aurum.com", Password = "123", DateBirth = new DateTime(2000,1,1), TypeUserId = roles["Usuário"], Active = true }
            };
